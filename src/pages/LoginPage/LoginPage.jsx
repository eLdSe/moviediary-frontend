  ...
  return (
    <div style={styles.root}>
      ...
      <div style={styles.card}>
        ...
        <h1 style={styles.heading}>С возвращением</h1>
        <p style={styles.sub}>Войдите, чтобы продолжить работу</p>
          ...
          >
            {loading ? (
              <span style={styles.spinnerWrap}>
                <svg style={styles.spinner} width="18" height="18" viewBox="0 0 18 18" fill="none">
